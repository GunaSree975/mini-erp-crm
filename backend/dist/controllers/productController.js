...
exports.getStockMovements = exports.addStockMovement = exports.updateProduct = exports.createProduct = exports.getProductById = exports.getProducts = exports.stockMovementSchema = exports.productSchema = void 0;
...
exports.productSchema = zod_1.z.object({
    ...
    unitPrice: zod_1.z.number().positive('Unit price must be greater than 0'),
    currentStock: zod_1.z.number().int().min(0, 'Stock cannot be negative'),
    minStockAlertInt: zod_1.z.number().int().min(0, 'Minimum stock alert must be 0 or higher'),
    locationWarehouse: zod_1.z.string().min(2, 'Warehouse location is required'),
});
exports.stockMovementSchema = zod_1.z.object({
    quantityChanged: zod_1.z.number().int().positive('Quantity changed must be greater than 0'),
